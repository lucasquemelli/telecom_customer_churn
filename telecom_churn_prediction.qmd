...
We also prepared the target variable for training and test datasets. For the both datasets, what we did means: if the variable Churn is equals "Yes", then attribute to it the valor 1, else 0.
